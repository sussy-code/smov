...
export function Discover() {
  ...
  useEffect(() => {
    if (!loggedIn && conf().DISABLE_FETCH_WITHOUT_LOGIN) return;
        ...
        >
          ...
          {medias
            ...
            .map((media) => (
              ...
              >
                <Flare.Base className="group cursor-pointer rounded-xl relative p-[0.65em] bg-background-main transition-colors duration-100 bg-transparent">
                  <img
                    src={
                      media.poster_path
